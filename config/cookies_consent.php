<?php
    ...
    return [
         ...
         * }
         */
      'cookie_prefix' => env('COOKIE_PREFIX').'_',
      ...
      'cookie_policy_page_custom_url' => null,
        // Set the custom page URL if use_separate_page is set to true and you want to use a custom URL or Laravel route
        /*
        |--------------------------------------------------------------------------
        | Editor
        |--------------------------------------------------------------------------
      ...
      'cookies' => [
        'strictly_necessary' => [
          [
            ...
            'name' => env('COOKIE_PREFIX').'_cookies_consent',
