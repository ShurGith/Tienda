    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="border-b border-gray-700">
        <div class="flex h-16 items-center justify-between px-4 sm:px-0">
          ...
          <div class="hidden lg:flex flex items-center md:ml-6">
            @php
            ...
            <div class="relative ml-3">
              @auth
                <button type="button"
                        class="hidden relative lg:flex max-w-xs items-center rounded-full bg-gray-800 text-sm"
            ...
            @auth
              <div id="mainmenu"
                ...
                <div class="flex flex-col items-start justify-start gap-2 my-2">
                  ...
                  @endforeach
                  <!-- AQUI ESTAMOS -->
                  <div class="-mr-2 mt-24 flex flex-col lg:hidden">
                    <!-- Mobile menu button -->
                    <button type="button"
                  ...
                  <div class="border-b border-gray-700" id="mobile-menu">
                    <div class="mt-24 space-y-1 px-2 py-3 sm:px-3">
                      <x-partials.nav-link href="{{ route('home') }}"
                                           :active="request()->routeIs('home')">{{  __('Home') }}</x-partials.nav-link>
                      <x-partials.nav-link href="{{ route('products.index') }}"
                                           :active="request()->routeIs('products.index')">{{  __('Productos') }}</x-partials.nav-link>
