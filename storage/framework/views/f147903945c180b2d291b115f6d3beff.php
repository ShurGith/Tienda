...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleHighlight().run()','active' => 'highlight','label' => ''.e(trans('filament-tiptap-editor::editor.highlight')).'','icon' => 'highlight']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleHighlight().run()','active' => 'highlight','label' => ''.e(trans('filament-tiptap-editor::editor.highlight')).'','icon' => 'highlight']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/highlight.blade.php ENDPATH**/ ?>