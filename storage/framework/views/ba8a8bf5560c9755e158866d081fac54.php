...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleBold().run()','active' => 'bold','label' => ''.e(trans('filament-tiptap-editor::editor.bold')).'','icon' => 'bold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleBold().run()','active' => 'bold','label' => ''.e(trans('filament-tiptap-editor::editor.bold')).'','icon' => 'bold']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/bold.blade.php ENDPATH**/ ?>