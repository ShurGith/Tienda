...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleItalic().run()','active' => 'italic','label' => ''.e(trans('filament-tiptap-editor::editor.italic')).'','icon' => 'italic']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleItalic().run()','active' => 'italic','label' => ''.e(trans('filament-tiptap-editor::editor.italic')).'','icon' => 'italic']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/italic.blade.php ENDPATH**/ ?>