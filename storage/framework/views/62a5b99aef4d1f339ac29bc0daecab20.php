...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.page','data' => ['metaTitle' => $product->name,'headerText' => $product->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['meta-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->name),'header-text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->name)]); ?>
  <!-- ## Sección Principal ## -->
    ...
    <div class="lg:grid lg:grid-cols-2 gap-6 lg:items-start">
      ...
      <div class="flex flex-col border">
        ...
        <div class="mt-6 hidden w-full max-w-2xl sm:block lg:max-w-none">
          <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" data-role="tablist">
            <?php $__currentLoopData = $product->getThumbs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              focus:ring-indigo-500/50 focus:ring-offset-4" role="tab" type="button">
                ...
                <span class="absolute inset-0 overflow-hidden rounded-md"> <img
                    src="<?php echo e(asset( $thumb)); ?>" data-role="img-slider"
                    alt="<?php echo e($thumb); ?>" class="size-full object-cover"> </span>
              </button>
      ...
      <div class="pt-12 flex flex-col justify-center items-center gap-y-4 px-4 sm:mt-16 sm:px-0 lg:mt-0">
        <h1 class="text-5xl mb-4 font-bold tracking-tight text-gray-900"
            data-role="name-product"><?php echo e($product->name); ?></h1>
        <!-- Precio -->
        <?php echo $__env->make('components.partials.precios' ,[ "textFinal" => "text-3xl"], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!-- Fin Precio -->
        <!-- Estrellas -->
        ...
        <div class="mt-6">
          ...
          <div class="space-y-6 text-base text-gray-700">
            <?php echo tiptap_converter()->asHTML($product->description); ?>
          ...
          <?php if($product->oferta): ?>
            <div
              ...
              <?php echo e($product->descuento); ?>% <?php echo e(__('Discount')); ?>
        ...
        <?php if($product->units): ?>
          ...
          <div class="flex items-center gap-x-4">
            <!-- Botón Add to Bag -->
            <a href="<?php echo e(route('product.buyit', $product)); ?>"
  ...
  <section aria-labelledby="details-heading" class="mt-12 grid sm:grid-cols-[repeat(auto-fit,minmax(0,1fr))] gap-12">
    ...
    <div>
      <h2 id="details-heading" class="pb-2"><?php echo e(__('Additional details')); ?></h2>
      <?php $__currentLoopData = $product->featuretitles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div data-role="tab-info"
          ...
          <button type="button"
            ...
            <h3 class="text-sm font-medium pl-4 text-gray-900"> <?php echo e($feature->title); ?></h3>
          ...
          <div class="overflow-hidden" id="disclosure">
            <?php echo tiptap_converter()->asHTML($feature->text); ?>
    ...
    <div>
      <h2 id="details-heading" class=""><?php echo e(__('Categories')); ?></h2>
    ...
    <div class="mt-8 grid grid-cols-2 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
      <?php $__currentLoopData = $randoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $random): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="relative h-72 w-full overflow-hidden rounded-lg">
          <img
            src="<?php echo e($random->getImgPal()); ?>"
            alt="Front of zip tote bag with white canvas, black canvas straps and handle, and black zipper pulls."
            class="size-full object-cover">
          
          <div class="absolute top-2 ">
            <h3 class="text-sm font-medium text-gray-900"><?php echo e($random->name); ?></h3>
            <?php if($random->descuento): ?>
              <span
                ...
                <?php echo e($random->descuento .'% '. __('Discount')); ?></span>
            <?php endif; ?>
          </div>
          <div
            ...
            <p class="relative text-lg font-semibold text-white"><?php echo e($random->precios($random->oferta)); ?>

              <span class="align-super text-base"><?php echo e($random->precios($random->oferta, true)); ?></span> €</p>
          </div>
          <a href="<?php echo e(route('products.show', $random)); ?>"
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'z-10 h-10 w-10 cursor-pointer','id' => 'closeModal']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script src="<?php echo e(asset('js/show-product.js')); ?>"></script>
<?php /**PATH /Users/juan/Herd/Tienda/resources/views/product/show.blade.php ENDPATH**/ ?>