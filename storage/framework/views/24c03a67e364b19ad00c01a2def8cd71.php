...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleSubscript().run()','active' => 'subscript','label' => ''.e(trans('filament-tiptap-editor::editor.subscript')).'','icon' => 'subscript']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleSubscript().run()','active' => 'subscript','label' => ''.e(trans('filament-tiptap-editor::editor.subscript')).'','icon' => 'subscript']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/subscript.blade.php ENDPATH**/ ?>