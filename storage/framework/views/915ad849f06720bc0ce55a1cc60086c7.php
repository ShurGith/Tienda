...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleLead().run()','active' => 'leadParagraph','label' => ''.e(trans('filament-tiptap-editor::editor.lead')).'','icon' => 'lead']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleLead().run()','active' => 'leadParagraph','label' => ''.e(trans('filament-tiptap-editor::editor.lead')).'','icon' => 'lead']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/lead.blade.php ENDPATH**/ ?>