...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleUnderline().run()','active' => 'underline','label' => ''.e(trans('filament-tiptap-editor::editor.underline')).'','icon' => 'underline']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleUnderline().run()','active' => 'underline','label' => ''.e(trans('filament-tiptap-editor::editor.underline')).'','icon' => 'underline']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/underline.blade.php ENDPATH**/ ?>