...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleStrike().run()','active' => 'strike','label' => ''.e(trans('filament-tiptap-editor::editor.strike')).'','icon' => 'strike']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleStrike().run()','active' => 'strike','label' => ''.e(trans('filament-tiptap-editor::editor.strike')).'','icon' => 'strike']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/strike.blade.php ENDPATH**/ ?>