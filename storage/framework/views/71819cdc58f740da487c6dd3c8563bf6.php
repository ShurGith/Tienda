...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleBlockquote().run()','active' => 'blockquote','label' => ''.e(trans('filament-tiptap-editor::editor.blockquote')).'','icon' => 'blockquote']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleBlockquote().run()','active' => 'blockquote','label' => ''.e(trans('filament-tiptap-editor::editor.blockquote')).'','icon' => 'blockquote']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/blockquote.blade.php ENDPATH**/ ?>