...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleBulletList().run()','active' => 'bulletlist','label' => ''.e(trans('filament-tiptap-editor::editor.list.bulleted')).'','icon' => 'bulletlist']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleBulletList().run()','active' => 'bulletlist','label' => ''.e(trans('filament-tiptap-editor::editor.list.bulleted')).'','icon' => 'bulletlist']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/bullet-list.blade.php ENDPATH**/ ?>