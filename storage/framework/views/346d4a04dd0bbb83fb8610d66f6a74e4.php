...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().redo().run()','active' => 'redo','label' => ''.e(trans('filament-tiptap-editor::editor.redo')).'','icon' => 'redo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().redo().run()','active' => 'redo','label' => ''.e(trans('filament-tiptap-editor::editor.redo')).'','icon' => 'redo']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/redo.blade.php ENDPATH**/ ?>