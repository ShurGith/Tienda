...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleOrderedList().run()','active' => 'orderedlist','label' => ''.e(trans('filament-tiptap-editor::editor.list.ordered')).'','icon' => 'orderedlist']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleOrderedList().run()','active' => 'orderedlist','label' => ''.e(trans('filament-tiptap-editor::editor.list.ordered')).'','icon' => 'orderedlist']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/ordered-list.blade.php ENDPATH**/ ?>