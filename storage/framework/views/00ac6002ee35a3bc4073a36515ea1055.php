...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleCodeBlock().run()','active' => 'codeBlock','label' => ''.e(trans('filament-tiptap-editor::editor.code_block')).'','icon' => 'code-block']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleCodeBlock().run()','active' => 'codeBlock','label' => ''.e(trans('filament-tiptap-editor::editor.code_block')).'','icon' => 'code-block']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/code-block.blade.php ENDPATH**/ ?>