...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().undo().run()','active' => 'undo','label' => ''.e(trans('filament-tiptap-editor::editor.undo')).'','icon' => 'undo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().undo().run()','active' => 'undo','label' => ''.e(trans('filament-tiptap-editor::editor.undo')).'','icon' => 'undo']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/undo.blade.php ENDPATH**/ ?>