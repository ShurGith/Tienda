...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().commands.clearContent(true)','label' => ''.e(trans('filament-tiptap-editor::editor.erase')).'','icon' => 'erase']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().commands.clearContent(true)','label' => ''.e(trans('filament-tiptap-editor::editor.erase')).'','icon' => 'erase']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/erase.blade.php ENDPATH**/ ?>