...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().setHorizontalRule().run()','active' => 'horizontalRule','label' => ''.e(trans('filament-tiptap-editor::editor.hr')).'','icon' => 'hr']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().setHorizontalRule().run()','active' => 'horizontalRule','label' => ''.e(trans('filament-tiptap-editor::editor.hr')).'','icon' => 'hr']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/hr.blade.php ENDPATH**/ ?>