...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().setParagraph().run()','active' => 'paragraph','label' => ''.e(trans('filament-tiptap-editor::editor.paragraph')).'','icon' => 'paragraph']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().setParagraph().run()','active' => 'paragraph','label' => ''.e(trans('filament-tiptap-editor::editor.paragraph')).'','icon' => 'paragraph']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/paragraph.blade.php ENDPATH**/ ?>