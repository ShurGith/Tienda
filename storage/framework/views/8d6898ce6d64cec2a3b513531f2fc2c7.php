...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'editor().chain().focus().toggleCode().run()','active' => 'code','label' => ''.e(trans('filament-tiptap-editor::editor.code')).'','icon' => 'code']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'editor().chain().focus().toggleCode().run()','active' => 'code','label' => ''.e(trans('filament-tiptap-editor::editor.code')).'','icon' => 'code']); ?>
...
<?php endif; ?><?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/code.blade.php ENDPATH**/ ?>