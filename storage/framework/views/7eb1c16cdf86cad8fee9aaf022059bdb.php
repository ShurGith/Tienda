<div class="filament-icon-picker-icon-column px-4 py-3">
	<!--[if BLOCK]><![endif]--><?php if($icon = $getState()): ?>
...
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/guava/filament-icon-picker/src/../resources/views/tables/icon-column.blade.php ENDPATH**/ ?>