...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => '$wire.dispatchFormEvent(\'tiptap::setGridBuilderContent\', \''.e($statePath).'\', {})','active' => 'grid-builder','label' => ''.e(trans('filament-tiptap-editor::editor.grid-builder.label')).'','icon' => 'grid-builder']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => '$wire.dispatchFormEvent(\'tiptap::setGridBuilderContent\', \''.e($statePath).'\', {})','active' => 'grid-builder','label' => ''.e(trans('filament-tiptap-editor::editor.grid-builder.label')).'','icon' => 'grid-builder']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/grid-builder.blade.php ENDPATH**/ ?>