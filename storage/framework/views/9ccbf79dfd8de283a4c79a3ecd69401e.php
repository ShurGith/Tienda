...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['action' => 'openModal()','label' => ''.e(trans('filament-tiptap-editor::editor.source')).'','icon' => 'source','xData' => '{
        openModal() {
            $wire.dispatchFormEvent(\'tiptap::setSourceContent\', \''.e($statePath).'\', { html: this.editor().getHTML() });
        }
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'openModal()','label' => ''.e(trans('filament-tiptap-editor::editor.source')).'','icon' => 'source','x-data' => '{
        openModal() {
            $wire.dispatchFormEvent(\'tiptap::setSourceContent\', \''.e($statePath).'\', { html: this.editor().getHTML() });
        }
    }']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/juanjose/Herd/Tienda/vendor/awcodes/filament-tiptap-editor/src/../resources/views/components/tools/source.blade.php ENDPATH**/ ?>